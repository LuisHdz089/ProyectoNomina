...
BEGIN
    ...
    INSERT INTO log_auditoria (operacion, esquema_afectado, objeto_afectado, id_usuario_app, dato_anterior, dato_nuevo)
    VALUES ('UPDATE', DATABASE(), 'cat_usuarios', @id_usuario_activo, 
